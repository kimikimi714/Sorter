...
sub values : Tests {
    ...
    is_deeply [$sorter->get_values], [], 'ソートなしリストがからのとき';
...
sub sort : Tests {
    my $sorter = Sorter->new;
    $sorter->sort;
    is_deeply [$sorter->get_values], [], 'リストがからのとき';

    $sorter->set_values(1);
    $sorter->sort;
    is_deeply [$sorter->get_values], [1], 'リスト１個のとき';

    $sorter->set_values(5,4,3,2,1);
    $sorter->sort;
    is_deeply [$sorter->get_values], [1,2,3,4,5], 'ソート後リスト要素５こ';
